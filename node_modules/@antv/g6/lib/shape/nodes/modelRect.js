...
Shape.registerNode('modelRect', {
  ...
  drawShape: function drawShape(cfg, group) {
    ...
    var _this$options = this.options,
        ...
        defaultPreRect = _this$options.preRect;
  ...
  update: function update(cfg, item) {
    ...
    var _this$options3 = this.options,
        ...
        defaultPreRect = _this$options3.preRect,
        defaultLogoIcon = _this$options3.logoIcon,
        defaultStateIcon = _this$options3.stateIcon;
    var customStyle = customOptions.style,
