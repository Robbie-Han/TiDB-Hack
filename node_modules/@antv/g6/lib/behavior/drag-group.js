...
module.exports = {
  ...
  updatePosition: function updatePosition(evt) {
    ...
    if (parentGroupId) {
      ...
      if (!(x < maxX && x > minX && y < maxY && y > minY)) {
        ...
        var paddingValue = customGroupControll.getGroupPadding(parentGroupId);
  ...
  updateItemPosition: function updateItemPosition(evt) {
    ...
    var groupId = evt.target.get('groupId');
    var graph = this.graph;
    var groupType = graph.get('groupType'); // 获取群组对象
    ...
    otherGroupId.forEach(function (id) {
      ...
      if (groupType === 'circle') {
        ...
        var paddingValue = customGroupControll.getGroupPadding(id);
        groupKeyShape.attr({
          x: x - paddingValue,
          y: y - paddingValue
        });
